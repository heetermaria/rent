...
plot6 <- ggplot(df, aes(x=as.Date(date), y=mean_mean_nom_contract_rent)) + geom_line() + labs(caption ="Source: 1-Year American Community Survey") + ylab("Dollars") + xlab("Date of Observation") + scale_y_continuous(label=comma)
